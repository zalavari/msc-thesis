...
A minimális vágás problémája könnyen felírható QUBO-ként, ahogyan azt \az+\refstruc{sec:MinCutQUBO+ben} láttuk. Az egyetlen amire figyelni kell, hogy két speciális pontot ki kell jelölni, amelyeknek külön csoportba kell kerülniük. Mivel azonban ez a klasszikus folyamalgoritmusnál is így működik, ezért ilyen tekintetben ez a megoldás sem alsórendűbb ahhoz képest.
