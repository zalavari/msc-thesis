...
\Az+\refstruc{sec:QUBO+ban} már használtuk a korlátmentesség fogalmát, a \az+\refstruc{sec:QUBOform+ban} pedig röviden látni fogjuk, hogy a kvantumszámítógépek segítségével elméletileg hatékonyan megoldhatóak a QUBO feladatok.
...
Mint ahogy a \az+\refstruc{fig:K3embedding} is mutatja, a $K_3$ beágyazása csak úgy lehetséges, ha igénybe veszünk legalább még egy 4. fizikai qubitet, és valamelyik logikai qubit reprezentálásához kettő fizikai qubitet használunk fel, melyek értékét egyenlővé tesszük.
